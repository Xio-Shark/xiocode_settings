...
**[2/8] python3 "$TRELLIS_SCRIPTS/"task.py create "Fix bug" --slug fix-bug** - Track work for future reference
...
**[2/4] python3 "$TRELLIS_SCRIPTS/"task.py create "Planning task" --slug planning-task** - Planning is valuable work
...
```bash
python3 "$TRELLIS_SCRIPTS/"task.py create "Fill spec guidelines" --slug fill-spec-guidelines
```
